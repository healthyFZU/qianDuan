  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "099c73ff-7-" + i0 + "," + ("099c73ff-6-" + i0),
        c: common_vendor.t(item.name),
        d: "099c73ff-8-" + i0 + "," + ("099c73ff-6-" + i0),
        e: common_vendor.t(item.address),
        f: "099c73ff-9-" + i0 + "," + ("099c73ff-6-" + i0),
        g: "099c73ff-10-" + i0 + "," + ("099c73ff-6-" + i0),
        h: index,
        i: "099c73ff-6-" + i0 + ",099c73ff-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "099c73ff-0"),
