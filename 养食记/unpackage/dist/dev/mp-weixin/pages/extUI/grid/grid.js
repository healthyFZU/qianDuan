...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "54a238c6-4-" + i0 + "," + ("54a238c6-3-" + i0),
        b: index,
        c: "54a238c6-3-" + i0 + ",54a238c6-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "54a238c6-8-" + i0 + "," + ("54a238c6-7-" + i0),
        b: index,
        c: "54a238c6-7-" + i0 + ",54a238c6-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "54a238c6-22-" + i0 + "," + ("54a238c6-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
